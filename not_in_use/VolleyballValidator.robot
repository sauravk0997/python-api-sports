...
*** Keywords ***
Validate Sports Schema of volleyball
    [Documentation]    Validating the key-values of Sports schema
    [Arguments]    ${response}  ${id}   ${uid}   ${guid}  ${name}   ${slug}  ${league_key_flag}
...
Validate League Schema of volleyball
    ...
    FOR    ${iter}  IN RANGE    ${len}
        ...
        Validate the value matches the regular expression    ${response}[${league}][${iter}]  groupId     ^[0-9]*$
...
Validate Season Schema of volleyball
