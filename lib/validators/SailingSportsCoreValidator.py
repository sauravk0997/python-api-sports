...
class SailingSportsCoreValidator(object):
    ...
    def sports_resp_is_valid(self, response) -> bool:
        ...
        """
        try:
            schema = SailingSportSchema().load(response.json())
