...
class WrestlingSportsCoreValidator(object):
    ...
    def sports_resp_is_valid(self, response) -> bool:
        ...
        """
        try:
            schema = WrestlingSportSchema().load(response.json())
