...
class BoxingSportsCoreValidator(object):
    ...
    def sports_resp_is_valid(self, response) -> bool:
        ...
        """
        try:
            schema = BoxingSportSchema().load(response.json())
