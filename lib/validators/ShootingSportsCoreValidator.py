...
class ShootingSportsCoreValidator(object):
    ...
    def sports_resp_is_valid(self, response) -> bool:
        ...
        """
        try:
            schema = ShootingSportSchema().load(response.json())
