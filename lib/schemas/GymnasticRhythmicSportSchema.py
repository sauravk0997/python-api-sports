...
class GymnasticRhythmicLeagueSchema(LeagueSchema):
    class Meta:
        unknown = RAISE
...
class GymnasticRhythmicSportSchema(SportSchema):
    """
        Schema for gymnastic-rhythmic sport endpoints

    """
    class Meta:
        unknown = RAISE

    leagues          = fields.List(fields.Nested(GymnasticRhythmicLeagueSchema), required=False)
