...
class FieldHockeyLeagueSchema(LeagueSchema):
    class Meta:
        unknown = RAISE
...
class FieldHockeySportSchema(SportSchema):
    """
    ...
    leagues          = fields.List(fields.Nested(FieldHockeyLeagueSchema), required=False)
